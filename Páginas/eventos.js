...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Adicionar contador de eventos por categoria
    function updateEventCount() {
        const categories = ['educacao', 'cultura', 'tecnologia', 'esporte', 'musica'];
